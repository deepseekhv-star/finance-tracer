...
from pymongo import MongoClient, DESCENDING # để tạo kết nối DB
import config # lấy dữ liệu từ config.py
...
class DatabaseManager: 
    ...
    def _initialize(self):
        ...
        try:
            ...
            self._create_index() # Tạo index hoac update cho DB (hàm bên dưới)
