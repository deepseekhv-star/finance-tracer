...
st.markdown("**interactive + editable**")
st.write(df) # static table
...
col11, col21, col31, col41 = st.columns(4) #1 2 3 +
col12, col22, col32, col42 = st.columns(4) #4 5 6 -
col13, col23, col33, col43 = st.columns(4) #7 8 9 x
col14, col24, col34, col44 = st.columns(4) #0 C , :
